...
#Cobrimento
c = 3 #cm
#Diâmetro da armadura escolhida principal (tracionada) (5/6.3/8/10/12.5/16/20/25/32)
diam = 25 #mm
#Diâmetro da armadura escolhida comprimida (5/6.3/8/10/12.5/16/20/25/32)
diam_as2 = 10 #mm
...
q = 8 #kN/m
#Armadura calculada - Fazer o cálculo para ELU primeiro e depois inserir o valor aqui !
as_calc = 9.47 #cm2
